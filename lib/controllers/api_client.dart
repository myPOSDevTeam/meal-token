 ...
 * Author:  A.Mathusan & Heshani Nanayakkara & Shakir
 * Created At: 04/2024
 * Description:
 *
 */
...
class ApiClient {
  ...
  static String baseURL =
      // 'http://10.162.36.28:5050/api/';
      //'https://wa-lpi-meal-token-api.azurewebsites.net/api/';
      //--------
      // 'https://lpimtapi.keellssuper.net/api/';
      //----------

      // 'https://lpimtapi.keellssuper.net/MYPOSSMS/api/';

      'http://192.168.1.29:5000/api/';
  // 'http://mealtokenapi.24x7retail.com/api/';
